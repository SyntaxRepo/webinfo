...
# PWA HTML Head content - This block will be injected into all templates
PWA_HEAD_CONTENT = """
...
<head>
    ...
    {PWA_HEAD_CONTENT} <!-- Inject PWA specific head content here -->
